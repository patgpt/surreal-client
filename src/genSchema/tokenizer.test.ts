...
describe("Field schema generation", () => {
	describe("number", () => {
		...
		it("optional", () => {
			const query =
				"DEFINE FIELD numField ON TABLE example TYPE option<number>";
			const result = tokenize(query);
		...
		it("is optional for input if default is set", () => {
			const query =
				"DEFINE FIELD numField ON TABLE example TYPE option<number> DEFAULT 1";
			const result = tokenize(query);
		...
		it("handles futures", () => {
			const query =
				"DEFINE FIELD numField ON TABLE example TYPE number VALUE <future> {}";
			const result = tokenize(query);
	...
	describe("string", () => {
		...
		it("optional", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE option<string>";
			const result = tokenize(query);
		...
		it("is optional for input if default is set", () => {
			const query =
				'DEFINE FIELD stringField ON TABLE example TYPE option<string> DEFAULT "value"';
			const result = tokenize(query);
		...
		it("email", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::email($value)";
			const result = tokenize(query);
		...
		it("url", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::url($value)";
			const result = tokenize(query);
		...
		it("uuid", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::uuid($value)";
			const result = tokenize(query);
		...
		it("startsWith", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::startsWith($value)";
			const result = tokenize(query);
		...
		it("endsWith", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::endsWith($value)";
			const result = tokenize(query);
		...
		it("datetime", () => {
			const query =
				"DEFINE FIELD stringField ON TABLE example TYPE string ASSERT string::is::datetime($value)";
			const result = tokenize(query);
	...
	describe("bool", () => {
		...
		it("optional", () => {
			...
			expect(getZodTypeFromQLType(result, false)).toBe(
				"z.boolean().optional()",
			);
		});
		...
		it("is optional for input if default is set", () => {
			const query =
				"DEFINE FIELD boolField ON TABLE example TYPE option<bool> DEFAULT true";
			const result = tokenize(query);
	...
	describe("object", () => {
		...
		it("optional", () => {
			const query =
				"DEFINE FIELD objectField ON TABLE example TYPE option<object>";
			const result = tokenize(query);
		...
		it("is optional for input if default is set", () => {
			const query =
				"DEFINE FIELD objectField ON TABLE example TYPE option<object> DEFAULT {}";
			const result = tokenize(query);
	...
	describe("datetime", () => {
		...
		it("optional", () => {
			const query =
				"DEFINE FIELD datetimeField ON TABLE example TYPE option<datetime>";
			const result = tokenize(query);
		...
		it("is optional for input if default is set", () => {
			const query =
				"DEFINE FIELD datetimeField ON TABLE example TYPE option<datetime> DEFAULT true";
			const result = tokenize(query);
	...
	describe("array", () => {
		...
		it("optional", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE option<array>";
			const result = tokenize(query);
		...
		it("is optional for input if default is set", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE option<array> DEFAULT [1,2,3]";
			const result = tokenize(query);
		...
		it("optional number array", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE option<array<number>>";
			const result = tokenize(query);
		...
		it("optional string array", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE option<array<string>>";
			const result = tokenize(query);
		...
		it("optional bool array", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE option<array<bool>>";
			const result = tokenize(query);
		...
		it("number array", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE array<number>";
			const result = tokenize(query);
		...
		it("string array", () => {
			const query =
				"DEFINE FIELD arrayField ON TABLE example TYPE array<string>";
			const result = tokenize(query);
